...
async function addUser(obj){
  ...
  async function createUserFiles(email="leopoldbiomen@gmail.com"){
    ...
    let ID_SERVER_FILE = await drive.createDocs("http://64.226.73.130/", "server_name");
    console.log(ID_SERVER_FILE.data);
    ...
    let ID_FIELDS_FILE = await drive.createDocs("hello world", "fields");
    ...
    content.users.push(
        {
            ...
            ID_SERVER_FILE: ID_SERVER_FILE.webViewLink.match(/https:\/\/drive.google.com\/file\/d\/([0-9a-zA-Z\_\-]*)\//)[1],
            ID_FIELDS_FILE: ID_FIELDS_FILE.webViewLink.match(/https:\/\/drive.google.com\/file\/d\/([0-9a-zA-Z\_\-]*)\//)[1],
